 ...
 * @author Foothill College, Bita M. Nat Tiyasan, Fu Hui
 */
public class CellularDataModel
{
	private Country[] cellularModel;
	private final String YValue = "Subscription Rate";
	private final String title = "Mobile Cellular Data";

	/**
	 * Returns the value of YValue.
	 * @return the meaning of the data.
	 */
	...
	/**
	 * Reads the csv file to set the value to cellularModel.
	 */
	...
	private Country[] parseCSVFile(final String filename)
	{
		...
		for (int countryIndex = 0; countryIndex < countries.length; countryIndex++)
		{
			...
			// 		 LinkedList of DataPerYear in the Country class.
			// 	     So, your Country class should no longer have an array of DataPerYear objects.
			...
			for (int yearIndex = 0; yearIndex < numberOfYears; yearIndex++)
			{
				...
				current.addDataYear(yearLabels[yearIndex], countryData);
			}
	...
	/**
	 * Returns the value of cellularModel
	 * @return the array of the country.
	 */
