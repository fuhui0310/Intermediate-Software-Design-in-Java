...
public class TestGenericList 
{
	...
	{		
		final String FILENAME = "resources\\cellular.csv";	// test file with shorter number of countries and subscription years
		...
		selectedCountryList = application.createRandomListOfCountries(countries);
		application.displayGeneratedList(selectedCountryList);
		application.testSearchInList(selectedCountryList);
		application.testSubscriptionsTotalInList(selectedCountryList);
