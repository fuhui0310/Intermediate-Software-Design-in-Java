...
public class CountryNode {
     ...
     * @param anotherCountryNode
     */
    public CountryNode(CountryNode anotherCountryNode){
        Country current = new Country(anotherCountryNode.getCountry());
    ...
    /**
     * Mutator method sets the country.
     * @param anotherCountry		The node replacing this node.
     */
    public void setCountry(Country anotherCountry){
        this.country = anotherCountry;
    }
